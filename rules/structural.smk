...
rule proc_structural:
    input:
        t1w=lambda wildcards: f"{bids_dir}/sub-{wildcards.subject}/ses-{wildcards.session}/anat/sub-{wildcards.subject}_ses-{wildcards.session}_{config['parameters']['proc_structural']['T1wStr']}.nii",
    output:
