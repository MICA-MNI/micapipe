...
R -e "install.packages('randomForest', version = '4.6-14')"
R -e "install.packages('e1071', version = '1.7-4')"
R -e "install.packages('party', version = '1.3-5')"
...
R -e "install.packages('class', version = '7.3-17')"
R -e "install.packages('ROCR', version = '1.0-11')"
R -e "install.packages('kernlab', version = '0.9-29')"
R -e "install.packages('coin', version = '1.3-1')"
R -e "install.packages('pkgconfig', version = '2.0.3')"
R -e "install.packages('MASS', version = '7.3-51.5')"
