...
The best example of how to set your local environment can be found in our `init.sh <https://github.com/MICA-MNI/micapipe/blob/master/functions/init.sh>`_ script.
