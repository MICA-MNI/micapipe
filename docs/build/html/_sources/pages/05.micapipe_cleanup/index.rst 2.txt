...
.. WARNING:: If you want to erase and rerun a core processing module such as ``post_structural`` or ``proc_structural`` you must rerun all its dependent modules, to ensure outputs consistency.
